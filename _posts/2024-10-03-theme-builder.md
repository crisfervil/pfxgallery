...
- cntThemeBuilderMain:
    ...
    - cntCredits:
        ...
        - lblCredits:
            Control: Text
            Properties:
              Text: ="Original idea taken from:"
              AlignInContainer: =AlignInContainer.Stretch
              Width: =160
        - lnkCredits:
            Control: Link
            Properties:
              Text: ="https://www.matthewdevaney.com/create-a-power-apps-custom-theme-colors-fonts-icons-controls/"
              URL: ="https://www.matthewdevaney.com/create-a-power-apps-custom-theme-colors-fonts-icons-controls/"
              AlignInContainer: =AlignInContainer.Stretch
              FillPortions: =1
    - cntThemeBuilderMainContent:
        Control: GroupContainer
        Variant: horizontalAutoLayoutContainer
        Properties:
          Fill: =RGBA(245, 245, 245, 1)
        ...
        - LeftContainer1:
            ...
            - tabStyles:
                ...
                Variant: pcfdataset
                Properties:
                  Items: =["Colors", "Fonts", "Icons", "Other"]
                  AlignInContainer: =AlignInContainer.Stretch
                ...
                - cntIconsList:
                    ...
                    - galIcons:
                        ...
                        - btnRemoveIcon:
                            Control: Button
                            Properties:
                              OnSelect: =Remove(colIcons,ThisItem)
                              Icon: ="Delete"
                              Text: =
                              Width: =43
                              X: =556
            ...
            - cntTabsStyles_Other:
                ...
                Properties:
                  LayoutDirection: =LayoutDirection.Vertical
                  LayoutMode: =LayoutMode.Auto
                  Visible: =tabStyles.Selected.Value="Other"
                Children:
                - cntStyleButtons:
                    Control: GroupContainer
                    Variant: horizontalAutoLayoutContainer
                ...
                - cntButtonSizeSmall:
                    ...
                    - cntButtonSizeSmallCtrls:
                        ...
                        - numButtonSizeSmall:
                            Control: NumberInput
                            Properties:
                              Value: =sldButtonSizeSmall.Value
                              AlignInContainer: =AlignInContainer.Center
                              LayoutMinWidth: =50
                              Width: =60
                - cntButtonSizeMedium:
                    ...
                    - cntButtonSizeMediumCtrls:
                        ...
                        - numButtonSizeMedium:
                            Control: NumberInput
                            Properties:
                              Value: =sldButtonSizeMedium.Value
                              AlignInContainer: =AlignInContainer.Center
                              LayoutMinWidth: =50
                              Width: =60
                - cntButtonSizeLarge:
                    ...
                    - cntButtonSizeLargeCtrls:
                        ...
                        - numButtonSizeLarge:
                            Control: NumberInput
                            Properties:
                              Value: =sldButtonSizeLarge.Value
                              AlignInContainer: =AlignInContainer.Center
                              LayoutMinWidth: =50
                              Width: =60
                - cntButtonSizeXLarge:
                    ...
                    - cntButtonSizeXLargeCtrls:
                        ...
                        - numButtonSizeXLarge:
                            Control: NumberInput
                            Properties:
                              Value: =sldButtonSizeXLarge.Value
                              AlignInContainer: =AlignInContainer.Center
                              LayoutMinWidth: =50
                              Width: =60
                - cntStyleBorders:
                            ...
                            Properties:
                              OnSelect: |-
                                ...
                                - lblLabel1:
                                    ...
                                    Properties:
                                      Align: ='TextCanvas.Align'.Center
                                      Font: =MyTheme.Fonts.Heading
                                      Size: =MyTheme.Fonts.Size.Regular
                            ...
                            Properties:
                              OnSelect: |-
                                ...
                                - btnButton1:
                                    Control: Button
                                    Properties:
                                      BasePaletteColor: =MyTheme.Colors.Secondary
                                      Font: =MyTheme.Fonts.Body
                                      FontSize: =MyTheme.Fonts.Size.Regular
                                      Text: =""Button""
                                      X: =148
                    ...
                    Properties:
                      Text: |-
                        ...
                        MyTheme = {{
                            ...
                            /// Button Height
                            Buttons:{{
                                Small: {sldButtonSizeSmall.Value},
                                Medium: {sldButtonSizeMedium.Value},
                                Large: {sldButtonSizeLarge.Value},
                                XLarge: {sldButtonSizeXLarge.Value}
                            }},
                            Borders:{{
                                Size:{sldBordersSize.Value},
                                Radius:{sldBordersRadius.Value},
                                Shadow:DropShadow.{drpBorderShadow.Selected.Value}
                            }},
                            Margins:{{
                                Small: {sldMarginSmall.Value},
                                Medium: {sldMarginMedium.Value},
                                Large: {sldMarginLarge.Value}
                            }},    
                            Icons:
                            {{
